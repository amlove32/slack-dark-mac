/** Confirmed to be working with Slack on macOS.  Dark theme.  Every time Slack updates, it breaks this file.
* To use:  wget this file and place it in:
* Applications -> Slack -> Show Package Contents -> Contents -> Resources -> app.asar.unpacked -> src -> static
* Slack should just build-in a dark mode.
**/
